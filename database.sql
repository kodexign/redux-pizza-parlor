...
VALUES 
('Tomato Soup','If you like pizza, but you hate the toppings, the cheese, and the crust, you''ll love this!',12.99,'/images/Tomatosoup.jpg'),
...
('Over the Rainbow','Taste the rainbow! One ingredient of each color: pepperoni, doritos, pineapple, olives, cheese, peppers and onion. Complimentary water served in a spray bottle to taste an actual rainbow.',19.99,'/images/OvertheRainbow.jpeg'),
...
('Another Little Pizza My Heart', 'Cheese Pizza. Personal size only.', 5.99,'/images/AnotherLittlePizzaMyHeart.png');
